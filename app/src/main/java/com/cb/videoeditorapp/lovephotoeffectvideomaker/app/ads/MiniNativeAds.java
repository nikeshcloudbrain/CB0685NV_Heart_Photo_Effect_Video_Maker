...
public class MiniNativeAds {
    ...
    public FrameLayout getFrameLayout(Activity activity, Dialog dialog) {
        if (dialog != null) {
            return dialog.findViewById(R.id.nativeAdMini);
        } else {
            return activity.findViewById(R.id.nativeAdMini);
        }
    }
    ...
    public TextView getTextLayout(Activity activity, Dialog dialog) {
        if (dialog != null) {
            return dialog.findViewById(R.id.ad_space_mini);
        } else {
            return activity.findViewById(R.id.ad_space_mini);
        }
    }
