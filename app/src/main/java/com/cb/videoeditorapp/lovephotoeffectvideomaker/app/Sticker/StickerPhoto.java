...
public abstract class StickerPhoto {
  ...
  @NonNull
  public StickerPhoto setFlippedHorizontally(boolean flippedHorizontally) {
  ...
  @NonNull
  public StickerPhoto setFlippedVertically(boolean flippedVertically) {
  ...
  public StickerPhoto setMatrix(@Nullable Matrix matrix) {
  ...
  public abstract StickerPhoto setDrawable(@NonNull Drawable drawable);
  ...
  @NonNull
  public abstract StickerPhoto setAlpha(@IntRange(from = 0, to = 255) int alpha);
  ...
  public boolean contains(@NonNull float[] point) {
    ...
    StickerUtilsPhoto.trapToRect(trappedRect, unrotatedWrapperCorner);
