 ...
 * @author wupanjie
 */
public class BitmapStickerIconPhoto extends DrawableStickerPhoto implements StickerIconEventPhoto {
  ...
  private StickerIconEventPhoto iconEvent;

  public BitmapStickerIconPhoto(Drawable drawable, @Gravity int gravity) {
    super(drawable);
  ...
  public StickerIconEventPhoto getIconEvent() {
    return iconEvent;
  }

  public void setIconEvent(StickerIconEventPhoto iconEvent) {
