...
public class TextStickerPhoto extends StickerPhoto {
  ...
  public TextStickerPhoto(@NonNull Context context) {
    this(context, null);
  }

  public TextStickerPhoto(@NonNull Context context, @Nullable Drawable drawable) {
    this.context = context;
    this.drawable = drawable;
    if (drawable == null) {
      this.drawable = ContextCompat.getDrawable(context, R.drawable.sticker_transparent_background_photo);
    }
  ...
  @NonNull
  @Override
  public TextStickerPhoto setAlpha(@IntRange(from = 0, to = 255) int alpha) {
  ...
  @Override
  public TextStickerPhoto setDrawable(@NonNull Drawable drawable) {
    this.drawable = drawable;
  ...
  @NonNull
  public TextStickerPhoto setDrawable(@NonNull Drawable drawable, @Nullable Rect region) {
    this.drawable = drawable;
    realBounds.set(0, 0, getWidth(), getHeight());
    if (region == null) {
      textRect.set(0, 0, getWidth(), getHeight());
  ...
  @NonNull
  public TextStickerPhoto setTypeface(@Nullable Typeface typeface) {
    textPaint.setTypeface(typeface);
    return this;
  }

  @NonNull
  public TextStickerPhoto setTextColor(@ColorInt int color) {
    textPaint.setColor(color);
    return this;
  }
  @NonNull
  public TextStickerPhoto setTextTexture(@Nullable Shader shader) {
    textPaint.setShader(shader);
    return this;
  }

  @NonNull
  public TextStickerPhoto set3d(@Nullable float radius, float dx, float dy, int color) {
    textPaint.setShadowLayer(radius,dx,dy, color);
    return this;
  }

  @NonNull
  public TextStickerPhoto setTextAlign(@NonNull Layout.Alignment alignment) {
    this.alignment = alignment;
    return this;
  }

  @NonNull
  public TextStickerPhoto setMaxTextSize(@Dimension(unit = Dimension.SP) float size) {
   ...
   */
  @NonNull
  public TextStickerPhoto setMinTextSize(float minTextSizeScaledPixels) {
    minTextSizePixels = convertSpToPx(minTextSizeScaledPixels);
    return this;
  }

  @NonNull
  public TextStickerPhoto setLineSpacing(float add, float multiplier) {
  ...
  @NonNull
  public TextStickerPhoto setText(@Nullable String text) {
    this.text = text;
    return this;
  }
   ...
   */
  @NonNull
  public TextStickerPhoto resizeText() {
